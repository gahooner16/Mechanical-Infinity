const NAGA_GATEWAY_ID = "gateway_of_naga";

ServerEvents.recipes(event => {

  Gateway.customBuilder(NAGA_GATEWAY_ID)
    .name("Gateway of Naga")
    .tooltipText("A multi‑wave undead trial ending with the Twilight Naga")
    .size("large")
    .color(0x3ba32e)
    ...
    // ---------------------------------------------------------
    .addWave(wave => {
      wave.addEntity("twilightforest:naga", 1);
      wave.maxTime(2400);
      wave.setupTime(150);
      wave.addEntityLootReward("twilightforest:naga", 1);
      wave.buildWave();
    })
    ...
    // ---------------------------------------------------------
    .addEntityLootReward("twilightforest:naga", 5)
  ...
  event.shaped(
    Gateway.createPearlItem(NAGA_GATEWAY_ID),
    [
      "PDP",
      "DCD",
      "PDP"
